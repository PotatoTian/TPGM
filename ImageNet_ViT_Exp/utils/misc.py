...
def dump_reg_logs(log_dir, logs):
    log_path = os.path.join(log_dir, "log_reg_stats.txt")
    with open(log_path, "a") as f:
        f.write(json.dumps(logs) + "\n")


def save_on_master(to_save, checkpoint_path):
    with open(checkpoint_path, "wb") as h_file:
        torch.save(to_save, h_file)
